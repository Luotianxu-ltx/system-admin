...
public class CodeGenerator {
    ...
    // 生成的代码放到哪个工程中
    private static String PROJECT_NAME = "system-manage";

    // 数据库名称
    private static String DATABASE_NAME = "system_admin";

    // 子包名
    private static String MODULE_NAME = "manage";
    ...
    public static void main(String[] args) {
        ...
        pc.setParent("com.system.admin"); //父包名
